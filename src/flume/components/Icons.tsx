...
export const MessageIcon: React.FC<SVGAttributes<SVGElement>> = props=> (
    <svg className="icon message-icon" { ...props } width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const UnMessageIcon: React.FC<SVGAttributes<SVGElement>> = props=> (
    <svg className="icon unmessage-icon" { ...props } width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const SearchIcon: React.FC<SVGAttributes<SVGElement>> = props=> (
    <svg className="icon search-icon" { ...props } width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const DotsIcon: React.FC<SVGAttributes<SVGElement>> = props=> (
    <svg className="icon dots-icon" { ...props } width="12" height="2" viewBox="0 0 12 2" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const VerDotsIcon: React.FC<SVGAttributes<SVGElement>> = props=> (
    <svg className="icon verdots-icon" { ...props } width="2" height="8" viewBox="0 0 2 8" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const CrossIcon: React.FC<SVGAttributes<SVGElement>> = props=> (
    <svg className="icon cross-icon" { ...props } width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const ArrowDownIcon: React.FC<SVGAttributes<SVGElement>> = props=> (
    <svg className="icon arrow-down-icon" { ...props } width="12" height="7" viewBox="0 0 12 7" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M1 1L6 6L11 1" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
);
export const ArrowUpIcon: React.FC<SVGAttributes<SVGElement>> = props=> (
    <svg className="icon arrow-up-icon" { ...props } width="12" height="7" viewBox="0 0 12 7" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const ArrowLeftIcon: React.FC<SVGAttributes<SVGElement>> = props=> (
    <svg className="icon arrow-left-icon" { ...props } width="8" height="13" viewBox="0 0 8 13" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const ArrowRightIcon: React.FC<SVGAttributes<SVGElement>> = props=> (
    <svg className="icon arrow-right-icon" { ...props } width="8" height="12" viewBox="0 0 8 12" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const CheckmarkIcon: React.FC<SVGAttributes<SVGElement>> = props=> (
    <svg className="icon checkmark-icon" { ...props } width="14" height="11" viewBox="0 0 14 11" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const CheckmarkCircleIcon: React.FC<SVGAttributes<SVGElement>> = props=> (
    <svg className="icon checkmark-icon" { ...props } width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const CheckmarksIcon: React.FC<SVGAttributes<SVGElement>> = props=> (
    <svg className="icon checkmarks-icon" { ...props } width="21" height="13" viewBox="0 0 21 13" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const SaveIcon: React.FC<SVGAttributes<SVGElement>> = props=> (
    <svg className="icon save-icon" { ...props } width="18" height="15" viewBox="0 0 18 15" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const SaveStackIcon: React.FC<SVGAttributes<SVGElement>> = props=> (
    <svg className="icon save-stack-icon" { ...props } width="18" height="12" viewBox="0 0 18 12" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const FolderIcon: React.FC<SVGAttributes<SVGElement>> = props=> (
    <svg className="icon folder-icon" { ...props } width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
