...
export const CheckmarkIcon: React.FC<SVGAttributes<SVGElement>> = props=> (
    <svg { ...props } width="14" height="11" viewBox="0 0 14 11" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const CheckmarksIcon: React.FC<SVGAttributes<SVGElement>> = props=> (
    <svg { ...props } width="21" height="13" viewBox="0 0 21 13" fill="none" xmlns="http://www.w3.org/2000/svg">
